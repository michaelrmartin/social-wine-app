Wine.create!([
  {name: "Espiral Vinho Verde", producer: "Espiral", vintage: 2018, blend: "Vinho Verde", price: "4.99", origin_id: 2},
  {name: "Rebuttel Chardonnay", producer: "Rebuttel", vintage: 2019, blend: "Chardonnay", price: "6.99", origin_id: 3},
  {name: "Josephine Cabernet Sauvignon", producer: "Josephine", vintage: 2020, blend: "Cabernet Sauvignon", price: "6.99", origin_id: 1},
  {name: "Cecilia Beretta Prosecco Rosé", producer: "Cecilia Beretta", vintage: nil, blend: "Prosecco Rosé", price: "10.99", origin_id: 4}
])
UserWine.create!([
